# Simulation II: Overlapping Brownian motion mixture
# Corresponds to Section 2.4.3 of thesis

# load EM functions
source("../bm_model/bm_em.R")
...
em <- EM.BMMM(Y, G, dt, maxstep=1000, tol=1e-6, init_func = initialise.variance)
